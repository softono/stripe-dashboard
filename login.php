...
<head>
    ...
    <title>Sign In - Stripe Dashboard</title>
    <!-- Tailwind CSS CDN -->
...
<body class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-50">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="flex justify-center mb-4">
            <div
                class="w-12 h-12 rounded-2xl bg-stripe-500 flex items-center justify-center text-white shadow-lg shadow-stripe-500/25">
        ...
        <h2 class="text-center text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
            Stripe<span class="text-stripe-500">Dashboard</span>
        </h2>
            ...
            <form method="POST" action="login.php" class="space-y-5" onsubmit="handleLoginSubmit(event)">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" name="email" type="email" autocomplete="email" required
                            value="<?= htmlspecialchars($emailValue) ?>" placeholder="admin@example.com"
                ...
                <div>
                    <button type="submit" id="submitBtn"
                        ...
                        <svg id="btnSpinner" class="hidden animate-spin h-4 w-4 text-white" fill="none"
                            viewBox="0 0 24 24">
