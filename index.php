...
$pageTitle = 'Dashboard - Stripe Dashboard';
...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <div class="flex items-center gap-3">
        <a href="transactions.php"
            class="inline-flex items-center gap-2 bg-stripe-600 hover:bg-stripe-700 text-white text-sm font-medium px-4 py-2 rounded-lg shadow-sm transition">
        ...
        <a href="customers.php"
            class="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 text-sm font-medium px-4 py-2 rounded-lg shadow-xs transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm mb-8 text-center max-w-2xl mx-auto">
    <div
        class="w-14 h-14 bg-stripe-50 text-stripe-600 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-stripe-100">
    ...
    <p class="text-sm text-slate-500 mt-2 max-w-md mx-auto">
        To view live customers, transactions, and subscriptions, enter your Stripe API Keys to store them in your active
        session.
    </p>
    <div class="mt-6 flex justify-center gap-3">
        <a href="connect.php"
            class="inline-flex items-center gap-2 bg-stripe-600 hover:bg-stripe-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl shadow-sm shadow-stripe-500/25 transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <a href="customers.php"
        class="group bg-white rounded-xl border border-slate-200 p-5 shadow-xs hover:border-stripe-500/50 hover:shadow-md transition block">
        <div class="flex items-center justify-between text-slate-500 text-xs font-medium uppercase tracking-wider">
            <span class="group-hover:text-stripe-600 transition">Customers</span>
            <div
                class="p-2 bg-blue-50 text-blue-600 rounded-lg group-hover:bg-stripe-50 group-hover:text-stripe-600 transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
    ...
    <a href="subscriptions.php"
        ...
        <div class="flex items-center justify-between text-slate-500 text-xs font-medium uppercase tracking-wider">
            ...
            <div
                class="p-2 bg-purple-50 text-purple-600 rounded-lg group-hover:bg-stripe-50 group-hover:text-stripe-600 transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-1.5 font-mono text-xs text-slate-700 font-medium">
                            ...
                            <button type="button"
                                ...
                                class="text-slate-400 hover:text-slate-600 p-1 rounded transition" title="Copy ID">
